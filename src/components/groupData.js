  ...
  sahn: [
    {
      ...
      icon: '',
      svg: ``,
      description: "در میانه صحن انقلاب اسلامی بنای زیبای سقاخانه وجود دارد. سنگاب منبع آب این سقاخانه از سنگ مرمر یکپارچه ای با گنجایش سه کر آب معادل ۱۱۳۰ لیتر است.",
      img: [s1, s2, s3],
