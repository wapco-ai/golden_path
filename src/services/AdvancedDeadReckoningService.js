...
class AdvancedDeadReckoningService {  
  ...
  toggle(initialLatLng = null) {  
    ...
    if (this.isActive) {  
      ...
      // اگر موقعیت مرجع ارسال شده است، از آن استفاده کنید  
      if (initialLatLng && initialLatLng.lat && initialLatLng.lng) {  
        ...
        console.warn('No initial position provided for Dead Reckoning');  
