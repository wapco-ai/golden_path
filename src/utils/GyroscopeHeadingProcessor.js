...
export class GyroscopeHeadingProcessor {
    ...
    // Add this method to your GyroscopeHeadingProcessor class
    setCoefficients(coefficients) {
        if (coefficients && coefficients.portrait && coefficients.landscape) {
            this.coefficients = {
                portrait: {
                    alpha: coefficients.portrait.alpha || this.coefficients.portrait.alpha,
                    beta: coefficients.portrait.beta || this.coefficients.portrait.beta,
                    gamma: coefficients.portrait.gamma || this.coefficients.portrait.gamma
                },
                landscape: {
                    alpha: coefficients.landscape.alpha || this.coefficients.landscape.alpha,
                    beta: coefficients.landscape.beta || this.coefficients.landscape.beta,
                    gamma: coefficients.landscape.gamma || this.coefficients.landscape.gamma
                }
            };
            console.log('Updated gyroscope coefficients:', JSON.stringify(this.coefficients));
        } else {
            console.warn('Invalid coefficients format provided to setCoefficients');
        }
    }
}
